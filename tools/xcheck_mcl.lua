...
local mcl = {}
local cur
for line in io.lines("/Users/markmurray/Downloads/MCL/guide/GuideData.lua") do
...
for _,f in ipairs(files) do
  local fh = io.open("/Users/markmurray/Downloads/MasterMountsWorldTour/Data/Data_"..f..".lua")
